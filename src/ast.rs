...
pub enum UnOp {
    Not,  /// `!`
    Neg   /// `-`, not actually used because the lexer doesn't know the difference
...
pub enum Symbol {
    ...
    Function {
        ...
        ret_ty: Type,
        body: Box<Node<Block>>,
        local_vars: HashMap<Ident, Type>  /// All local variables.
                                          // TODO: Store variables associated with a `Block` instead
    },
